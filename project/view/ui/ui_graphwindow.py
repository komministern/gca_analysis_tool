...
#
# Created: Sun Aug 18 14:47:13 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem = QtWidgets.QSpacerItem(1, 138, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_Y_Subplot_1.sizePolicy().hasHeightForWidth())
        self.comboBox_Y_Subplot_1.setSizePolicy(sizePolicy)
        self.comboBox_Y_Subplot_1.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_Y_Subplot_2.sizePolicy().hasHeightForWidth())
        self.comboBox_Y_Subplot_2.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_Y_Subplot_3.sizePolicy().hasHeightForWidth())
        self.comboBox_Y_Subplot_3.setSizePolicy(sizePolicy)
        ...
        self.groupBox_Deviation_Parameters = QtWidgets.QGroupBox(self.dockWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_Deviation_Parameters.sizePolicy().hasHeightForWidth())
        self.groupBox_Deviation_Parameters.setSizePolicy(sizePolicy)
        ...
        self.radioButton_DPI50 = QtWidgets.QRadioButton(self.groupBox_3)
        self.radioButton_DPI50.setObjectName("radioButton_DPI50")
        self.gridLayout_8.addWidget(self.radioButton_DPI50, 0, 0, 1, 1)
        self.radioButton_DPI75 = QtWidgets.QRadioButton(self.groupBox_3)
        self.radioButton_DPI75.setObjectName("radioButton_DPI75")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(1, 138, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_DPI50.setText(QtWidgets.QApplication.translate("MainWindow", "50", None, -1))
        self.radioButton_DPI75.setText(QtWidgets.QApplication.translate("MainWindow", "75", None, -1))
