...
class SitePresenter(QtCore.QObject):
    ...
    def update_site_(self, site_name):
    ...
    def import_capturesite_(self):

        capturesite_filename, _ = QtWidgets.QFileDialog.getOpenFileName(self.view, u'Choose capturesite file to import', self.model.database.home_directory, u'Capturesite (*tar.gz *TAR.Z)')
        ...
        if capturesite_filename[-2:] == '.Z':
            ...
            if not self.model.exist_7z():
                ...
                path_to_7z, _ = QtWidgets.QFileDialog.getOpenFileName(self.view, u'Path to 7z.exe', self.model.database.home_directory, u'7z console application (7z.exe)')
            ...
            if len(possible_matching_sites) == 0:
                ...
                if self.model.temp_site_newer_than(site_to_be_updated):
                    ...
                    if clicked == QtWidgets.QMessageBox.Ok:
                        self.update_site_(site_to_be_updated)
